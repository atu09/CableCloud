...
import com.mtaj.mtaj_08.cableplus_new.CustomPriorityRequest;
...
public class SyncDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spload = new SpotsDialog(SyncDataActivity.this, R.style.Custom);
                            ...
                            if (response.getString("status").toString().equals("True")) {
                                ...
                                for (int i = 0; i < entityarray.length(); i++) {
                                    ...
                                    if (myDB.insertArea(aid, aname, acode, Aoa, Acol)) {
                                        ...
                                        // Toast.makeText(SyncDataActivity.this, "A"+i, Toast.LENGTH_SHORT).show();
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (response.getString("status").toString().equals("True")) {
                                ...
                                //Toast.makeText(SyncDataActivity.this, "---", Toast.LENGTH_SHORT).show();
                                ...
                                for (int i = 0; i < entityarray.length(); i++) {
                                    ...
                                    if (myDB.insertCustomer(cid, cname, caddress, carea, cacno, cphone, cemail, castatus, cmq, ctotaloa, commentCount, bid, aid)) {
                                        // Toast.makeText(SyncDataActivity.this, "C"+i, Toast.LENGTH_SHORT).show();
                            ...
                            try {
                                ...
                                if (response.getString("status").toString().equals("True")) {
                                    ...
                                    for (int i = 0; i < entityarray.length(); i++) {
                                        ...
                                        String contractorId = e.getString("CustomerId");
                                        String cname = e.getString("Name");
                                        String caddress = e.getString("Address");
                                        String carea = e.getString("Area");
                                        String cacno = e.getString("AccountNo");
                                        ...
                                        if(dbHelper.insertCustomer(contractorId, cname, caddress,carea, cacno, cphone, cemail, castatus, cmq, ctotaloa, commentCount, bid, aid))
                                        {
                                            // Toast.makeText(SyncDataActivity.this, "C"+i, Toast.LENGTH_SHORT).show();
                                    ...
                                    *//*
                                    // Toast.makeText(SyncDataActivity.this, "DONE..!!", Toast.LENGTH_SHORT).show();
