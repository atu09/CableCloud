...
public class LoginActivityRevised extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    void loginCall() {
        Utils.closeKeyboard(LoginActivityRevised.this);
...
*/
    ...
    private class JSONLoginAsync extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            loader = Utils.getLoader(LoginActivityRevised.this);
            loader.show();
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            try {
                ...
                Toast.makeText(LoginActivityRevised.this, message, Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(LoginActivityRevised.this, "Something Went  Wrong...", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private class JSONEntityAsync extends AsyncTask<String, String, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            dbHelper = new DBHelper(LoginActivityRevised.this);
            loader = Utils.getLoader(LoginActivityRevised.this);
            loader.show();
        ...
        protected void onPostExecute(Boolean status) {
            ...
            if (status) {
                startActivity(new Intent(LoginActivityRevised.this, DashBoardActivity.class));
