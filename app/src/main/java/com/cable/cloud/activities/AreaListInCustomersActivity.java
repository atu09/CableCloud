...
public class AreaListInCustomersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SimpleAdapter(AreaListInCustomersActivity.this, areaList, R.layout.arealist_customers, new String[]{"AreaName", "TotalCustomer"}, new int[]{R.id.textView2, R.id.textView24});
        ...
        listView.setOnScrollListener(new InfiniteScrollListener(1) {
            ...
            public void loadMore(int page, int totalItemsCount) {
                ...
                AreaListInCustomersActivity.this.page = AreaListInCustomersActivity.this.page + 1;

                URL = siteURL + "/GetCustomersByAreaForCollectionApp?contractorId=" + contractorId + "&userId=" + userId + "&entityId=" + entities
                        + "&startindex=" + String.valueOf(AreaListInCustomersActivity.this.page) + "&noofrecords=20";
    ...
    private class JSONAsync extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            loader = Utils.getLoader(AreaListInCustomersActivity.this);
            loader.show();
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            try {
                ...
                if (json.getString("status").equalsIgnoreCase("True")) {
                    ...
                    Toast.makeText(AreaListInCustomersActivity.this, json.getString("message"), Toast.LENGTH_SHORT).show();
                }
