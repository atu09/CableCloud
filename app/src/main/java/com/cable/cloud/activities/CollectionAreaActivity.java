    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_datefilters:
               ...
               /* final AlertDialog.Builder alert = new AlertDialog.Builder(CollectionAreaActivity.this);
              ...
              /*  AlertDialog.Builder builder = new AlertDialog.Builder(CollectionAreaActivity.this));
